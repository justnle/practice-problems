...
Given an array of integers numbers that is already sorted in non-descending order,
find the two numbers such that they add up to a specific target number.
